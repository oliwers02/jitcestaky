...
1. Po každej väčšej práci si stiahnite zálohu:
   **Nastavenia → 💾 Záloha dát → Stiahnuť zálohu celej databázy (JSON)**.
2. Po reštarte appky zálohu obnovte:
   **Nastavenia → 💾 Záloha dát → Obnoviť databázu zo zálohy**.

Pri lokálnom behu sa dáta ukladajú trvalo do `data/cestaky.db`.
...
core/
  ...
  db.py                   # SQLite vrstva + JSON záloha/obnova
